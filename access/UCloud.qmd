...
**4.**  The left-side menu can be used to access the stored data, applications, running programs and settings. Use the **Applications** symbol (red circle) and click on the **Health Science** store (green circle). 
